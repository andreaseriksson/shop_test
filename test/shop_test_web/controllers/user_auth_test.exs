defmodule ShopTestWeb.UserAuthTest do
  use ShopTestWeb.ConnCase, async: true

  alias ShopTest.Accounts
  alias ShopTestWeb.UserAuth
  import ShopTest.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ShopTestWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ShopTestWeb.Endpoint.subscribe(live_socket_id)

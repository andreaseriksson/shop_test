defmodule ShopTest.ProductsTest do
  ...
  describe "products" do
    ...
    @valid_attrs %{description: "some description", name: "some name", price: "120.50"}
    @update_attrs %{description: "some updated description", name: "some updated name", price: "456.70"}

defmodule ShopTest.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ShopTest.Repo)
  ...
  """
  def valid_password?(%ShopTest.Accounts.User{hashed_password: hashed_password}, password)
